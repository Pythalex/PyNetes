...
class Application(Tk):
	...
	def retirer_planete(self, planete):

		if planete in self.planetes:
			if planete in self.selected_planetes:
				self.selected_planetes.remove(planete)
			else:
				self.canvas.delete(planete.pyimage)
	...
	def ajouter_bouton_planete(self, planete):
		...
		bouton                              = Planete_Bouton(self.select_planets_frame, planete, len(self.boutons_planetes), self)
		self.boutons_planetes.append		(bouton)
		planete.bouton                      = bouton
